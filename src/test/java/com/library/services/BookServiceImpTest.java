...
class BookServiceImpTest {
    ...
    void updateBookTitle_success() {
        ...
        assertDoesNotThrow(() ->
                bookServiceImp.updateBookTitle(1L, "Нова назва")
        );
    ...
    void updateBookTitle_bookNotFound() {
        ...
        RuntimeException ex = assertThrows(
                ...
                () -> bookServiceImp.updateBookTitle(99L, "Нова назва")
        );
    ...
    void getBookById_found() {
        ...
        Book result = bookServiceImp.getBookById(1L);
    ...
    void getBookById_notFound() {
        ...
        Book result = bookServiceImp.getBookById(2L);
    ...
    void createBook_success() {
        ...
        Book created = bookServiceImp.createBook(toCreate);
    ...
    void createBook_titleIsNull_throws() {
        ...
        RuntimeException ex = assertThrows(
                RuntimeException.class,
                () -> bookServiceImp.createBook(toCreate)
        );
